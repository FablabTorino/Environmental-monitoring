...
DeviceAddress insideThermometer, outsideThermometer, thirdThermometer;
...
void setup(void)
{
 ...
 // assigns the seconds address found to outsideThermometer
  if (!oneWire.search(thirdThermometer)) Serial.println("Unable to find address for thirdThermometer");
